...
def Cruise(vertical_pid, horizontal_pid, truck, nav_line, speed_plan):
    speed_target = min(speed_plan, truck['speedlimit'])
    vertical_pid.update_e(speed_target - truck['speed'])
