...
class Bev_Lanedet(object):
    ...
    def infer(self, img):
        ...
        self.update(line_l, line_r, line_ll, line_rr, line_m, line_z)
    
    def update(self, line_l, line_r, line_ll, line_rr, line_m, line_z):
        lane_dict = {'line_l': line_l, 'line_r': line_r, 
                     'line_ll': line_ll, 'line_rr': line_rr, 
                     'line_m': line_m, 'line_z':line_z, 'lane_width': self.lane_width}
